...
function TableInitialize (table) {
  if (table === 'diary-foods' || table === 'diary-exercises') {
    ...
    mealsJSON = localStorage.getItem(date)
...
$('#day-back').on('click', function() {
  ...
  if (!dayJSON) {
    ...
    makeTables();//grab the day and its things and make tables from it
  }
