...
function addEventListenerForEnter (className, oldName, oldCalories, el) {
...
function addEventListenerForMousedown (className, oldName, oldCalories, el) {
...
function makeEditable() {
  $('.foods').on('click', 'td', function (event) {
    ...
    var el = event.target;
    addEventListenerForEnter(className, oldName, oldCalories, el);
    addEventListenerForMousedown(className, oldName, oldCalories, el);
  });
};
