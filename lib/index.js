...
TableInitialize("dairy-foods");
TableInitialize("dairy-exercises");
TableInitialize("foods");
TableInitialize("exercises")
TableInitialize("exercise")

function TableInitialize (table) {
  if (table === 'dairy-foods' || table === 'dairy-exercises') {
...
var meals = $('.dairy-'+fromTable+' input[type=checkbox]:checked');
...
$('.add-breakfast').on('click', function (e) {
  ...
  $('.dairy-foods input[type=checkbox]').prop('checked', false);
})
